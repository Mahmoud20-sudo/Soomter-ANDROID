 ...
 */
public class BusenissCatgsAdapterV2 extends RecyclerView.Adapter<BusenissCatgsAdapterV2.MyViewHolder> {
    ...
    public BusenissCatgsAdapterV2(Context mContext, List<BussinesCatgData.Datum> albumList) {
