 ...
 */
public class ProductPropertiesFragment extends Fragment implements View.OnClickListener {
    ...
    public static ProductPropertiesFragment newInstance(String mParam1, String mParam2) {
        ProductPropertiesFragment fragment = new ProductPropertiesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_product_prop, container, false);

        type = Typeface.createFromAsset(getActivity().getAssets(), "fonts/SST-Arabic-Light.ttf");

        ProductPropsAdapter adapter = new ProductPropsAdapter(getContext(), resultObj.productsProperties);

        RecyclerView recyclerView = v.findViewById(R.id.product_props_rv);
