...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_UNCHECKED = Color.parseColor("#DADADB");
    private static final int COLOR_CHECKED = Color.parseColor("#D9B878");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#DADADB");
